sap.ui.define([
	...
	return Controller.extend("MyExtension20080815_MyMDKTest.controller.View1", {
        setUrl: function () {
            ...
            var url = sap.ui.require.toUrl("MyExtension20080815_MyMDKTest/mdkindex.html?" + queryString);
